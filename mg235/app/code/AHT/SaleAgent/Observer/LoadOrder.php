...
{
    /**
     * @param \AHT\SaleAgent\Model\SalesagentFactory $salesagentFactory
     *
     * @return string|null
     */
    ...
    public function __construct(\AHT\SaleAgent\Model\SalesagentFactory $salesagentFactory)
    {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        /** @var \AHT\SaleAgent\Model\Salesagent $salesagentModel */
